		...
		<div class="container">
			...
			<div class="row justify-content-center">
    		   ...
    		   <div class="alert alert-danger" role="alert">
		        ...
		        <?php } ?>
		      	<form action="loginUser.php" class="signin-form" method="POST" id="loginform">
	          ...
	          <div class="social d-flex text-center">
	          	<a href="register.php" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span> Register Here</a>
	          </div>
		      </div>
				</div>
			</div>
